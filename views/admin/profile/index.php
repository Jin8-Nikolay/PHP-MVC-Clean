...
<div class="btn-toolbar mb-2 mb-md-0">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="UserSetting[language]"
                   id="language" value="<?php echo $setting->getValue(1, 'language') ?>" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="language" class="col-sm-2 col-form-label"><?php echo Tr::t('admin', 'Email') ?></label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="UserSetting[email]"
                   id="language" value="<?php echo $setting->getValue(1, 'email') ?>" required>
        </div>
    </div>
